            ...
            <div class="row mt-4">
                <div class="col-4">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="name@example.com"
                        ...
                        <input type="text" class="form-control" id="nombre" name="id" placeholder="name@example.com"
                ...
                <label for="exampleFormControlInput1">Categoria Producto</label>
                    <select class="form-control mb-3" id="categoria" name="categoria">
                        ...
                        <?php
                            ...
                            $sql0="SELECT * FROM categorias WHERE Id=".$row['CategoriaId'];
                            $resultado0=$conexion->query($sql0);
                            $row1 = $resultado0->fetch_assoc();

                            echo "<option selected value='".$row1['Id']."'>".$row1['NombreCategoria']."</option>";


                            $sql1= $conexion->query("SELECT * FROM categorias");
                            while ($row1= $sql1 ->fetch_assoc()){
                                echo "<option value='".$row1['Id']."'>".$row1['NombreCategoria']."</option>";
                    ...
                    <label for="exampleFormControlInput1">Marcas</label>
                        ...
                        include ("conexion.php");
                           ...
                           $sql1="SELECT * FROM marcas WHERE Id=".$row['MarcaId'];
                            ...
                            echo "<option selected value='".$row2['Id']."'>".$row2['NombreMarca']."</option>";
